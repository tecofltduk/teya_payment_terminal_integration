# -*- coding: utf-8 -*-
# Module developed for Teya integration requirements
...

{
    ...
    "description": " Teya Payment Terminal Odoo Point of sale Integration."
                   "This module adds options to receive payment throught Teya"
                   "Terminal and sync the transaction details to POS session "
                   "automatically. ",
    "data": [
